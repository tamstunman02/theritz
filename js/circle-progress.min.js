								...
								this._isIndeterminate()
									...
									: ((e = this.clockwise),
									  ...
									  "none" !== this.animation && this.value !== this.graph.value
											...
											: (this.graph.sector.attr("d", s._makeSectorPath(50, 50, a, i, r, e)),
						...
						},
						{
							...
							value: function (t, e, r) {
								"function" == typeof this.textFormat
									...
									? (this.graph.text.el.textContent = void 0 !== t ? t : this.indeterminateText)
									...
									? (this.graph.text.el.textContent = "")
									: ((this.graph.textVal.el.textContent = void 0 !== t ? t : this.indeterminateText),
